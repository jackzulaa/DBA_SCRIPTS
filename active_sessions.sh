...
PROMPT
prompt ==============================================================
PROMPT Queries Running Since More Than 1 Hour On Instance [${ORACLE_SID}]:
PROMPT ==============================================================
...
and status = 'ACTIVE'; 
set pages 0
select 'To kill that session: ALTER SYSTEM DISCONNECT SESSION '''||sid ||','|| serial#||''' IMMEDIATE;'from v\$session where
username is not null 
and module is not null
-- 1 is the number of hours
and last_call_et > 60*60*1
